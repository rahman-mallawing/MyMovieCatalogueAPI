...
public class TvShowCredit {
    ...
    public TvShowCredit(int id, ArrayList<Cast> casts, ArrayList<Crew> crews) {
        this.id = id;
        this.casts = casts;
        this.crews = crews;
    }
    ...
    public class Cast {
        ...
        public Cast(String character, String credit_id, int gender, int id, String name, int order, String profile_path) {
