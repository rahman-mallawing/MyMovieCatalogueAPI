...
public class MovieDetail {
    ...
    public MovieDetail(boolean adult, String backdrop_path, Collection collection, double budget, ArrayList<Genre> genres, String homepage, int id, String imdb_id, String original_language, String original_title, String overview, double popularity, String poster_path, ArrayList<Company> companies, Date release_date, double revenue, int runtime, String status, String tagline, String title, boolean video, double vote_average, double vote_count) {
        this.adult = adult;
